...
eventgen jetreconstruction: $(PYTHIA) $$@.cc
	$(CXX) $@.cc -o $@ -w $(CXX_COMMON) $(FASTJET3_INCLUDE) $(FASTJET3_LIB) $(ROOT_LIB)\
...
main91 main% photoproduction analysis: $(PYTHIA) $$@.cc
ifeq ($(ROOT_USE),true)
...
main92 mymain01 : $(PYTHIA) $$@.cc main92.so
